<form action="#" v-on:submit.prevent="doSearch()">
	<div class="grid-container" v-if="load_error">
		<p class="text--alert">Error loading search form.</p>
	</div>
	<div class="grid-container member-search-form" v-else>
		...
		<div class="member-search-form__cta">
			<div class="member-search-form__cta-element">
				<button :disabled="inputs_disabled" class="button button--block button--info" type="button" v-on:click="clearForm">
					Clear
				</button>
			</div>
			<div class="member-search-form__cta-element">
				<button :disabled="inputs_disabled" class="button button--block" type="submit">
					{{search_button_text}}
				</button>
			</div>
		</div>
