...
export interface CheckInEntityCompetitionContactParameters extends CheckInEntityBaseParameters {
    email: string | null;
    phone: string | null;
}
...
export class CheckInEntityCompetitionContact extends AbstractCheckInEntity {
    check_in_fetch_required: boolean = true;
    coach_count: number = 0;
    email: string | null;
    entity_type_description: string = 'Competition Contact';
    entity_type_key: CheckInEntityTypeKey = 'competition_contact';
    ...
    constructor(parameters: CheckInEntityCompetitionContactParameters) {
        super(parameters);
