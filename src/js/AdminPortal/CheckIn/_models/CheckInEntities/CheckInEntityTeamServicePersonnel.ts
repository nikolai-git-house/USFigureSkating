...
export interface CheckInEntityTeamServicePersonnelParameters extends CheckInEntityBaseParameters {
    email: string | null;
    phone: string | null;
}
...
export class CheckInEntityTeamServicePersonnel extends AbstractCheckInEntity {
    check_in_fetch_required: boolean = true;
    coach_count: number = 0;
    email: string | null;
    entity_type_description: string = 'Team Service Personnel';
    entity_type_key: CheckInEntityTypeKey = 'team_personnel';
    ...
    constructor(parameters: CheckInEntityTeamServicePersonnelParameters) {
        super(parameters);
