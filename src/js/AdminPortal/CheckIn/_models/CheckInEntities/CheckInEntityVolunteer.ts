...
export interface CheckInEntityVolunteerParameters extends CheckInEntityBaseParameters {
    email: string | null;
...
export class CheckInEntityVolunteer extends AbstractCheckInEntity {
    check_in_fetch_required: boolean = true;
    coach_count: number = 0;
    email: string | null;
    entity_type_description: string = 'Volunteer';
    entity_type_key: CheckInEntityTypeKey = 'volunteer';
    ...
    constructor(parameters: CheckInEntityVolunteerParameters) {
        super(parameters);
